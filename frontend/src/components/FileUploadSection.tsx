    ...
    <section className="space-y-6">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-xs flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-4 w-full md:w-auto">
          <div className="p-2 bg-orange-50 rounded-lg text-orange-700 border border-orange-200">
            <Sliders className="w-4 h-4 text-orange-600" />
          </div>
          <div>
            <div className="flex items-center space-x-2">
              <span className="text-xs font-semibold text-slate-700 uppercase tracking-wider">
                Max Hop Limit: <strong className="text-orange-600 font-bold text-sm">{hopLimit} Rounds</strong>
              </span>
            </div>
            <p className="text-[11px] text-slate-500">Fallback landmark search depth limit</p>
          </div>
        ...
        <div className="flex items-center space-x-3 w-full md:w-auto justify-end">
          {!canRunMatch && (
            <div className="hidden lg:flex items-center space-x-1.5 text-xs text-orange-800 bg-orange-50 border border-orange-200 px-3 py-1.5 rounded-lg">
              <AlertCircle className="w-3.5 h-3.5 text-orange-600" />
              <span>Please upload both YP and MCP source files to execute matching</span>
            </div>
          )}
          ...
          <button
            ...
            className={`flex items-center justify-center space-x-2 px-6 py-2.5 rounded-lg font-semibold text-xs transition-all shadow-xs ${
              isMatching
